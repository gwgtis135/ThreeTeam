...
<body>
    ...
    <!-- End Shop Page -->
     ...
     <!-- ALL JS FILES -->
    <script src="inf/jsjquery-3.2.1.min.js"></script>
    <script src="inf/jspopper.min.js"></script>
    <script src="inf/jsbootstrap.min.js"></script>
    <!-- ALL PLUGINS -->
    <script src="inf/jsjquery.superslides.min.js"></script>
    <script src="inf/jsbootstrap-select.js"></script>
    <script src="inf/jsinewsticker.js"></script>
    <script src="inf/jsbootsnav.js."></script>
    <script src="inf/jsimages-loded.min.js"></script>
    <script src="inf/jsisotope.min.js"></script>
    <script src="inf/jsowl.carousel.min.js"></script>
    <script src="inf/jsbaguetteBox.min.js"></script>
    <script src="inf/jsjquery-ui.js"></script>
    <script src="inf/jsjquery.nicescroll.min.js"></script>
    <script src="inf/jsform-validator.min.js"></script>
    <script src="inf/jscontact-form-script.js"></script>
    <script src="inf/jscustom.js"></script>
